...
import uo.ri.ui.admin.payroll.action.ListPayrollsActionProductivityNull;
...
public class NominasMenu extends BaseMenu {
	...
	public NominasMenu() {
		menuOptions = new Object[][] { 
			...
			{ "Listar nóminas en la que la productividad haya sido nula", ListPayrollsActionProductivityNull.class}
		};
	}
