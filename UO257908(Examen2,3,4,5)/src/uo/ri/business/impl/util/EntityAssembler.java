...
public class EntityAssembler {
	...
	public static Contract toEntity(Mecanico mecanico, ContractDto dto, ContractCategory categoria, ContractType tipo) {
		return new Contract(mecanico, dto.startDate,dto.endDate,dto.yearBaseSalary,categoria,tipo);
	}
