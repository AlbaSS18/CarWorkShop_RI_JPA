...
import uo.ri.business.impl.contract.command.FindContractsMoreThanSalary;
...
public class ContractServiceImpl implements ContractCrudService{
	...
	@Override
	public List<ContractDto> findContractsMoreThanSalary(Double salary) throws BusinessException {
		return executor.execute(new FindContractsMoreThanSalary(salary));
	}
