...
import uo.ri.business.impl.mechanic.command.FindMechanicsUsedRepuesto;
import uo.ri.business.impl.mechanic.command.FindMechanicsWithoutActiveContract;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
	...
	@Override
	public List<MechanicDto> findMechanicsUsedRepuesto() throws BusinessException {
		return executor.execute(new FindMechanicsUsedRepuesto());
	}

	@Override
	public List<MechanicDto> findMechanicsWithoutActiveContract(Long idCategoria) throws BusinessException{
		return executor.execute(new FindMechanicsWithoutActiveContract(idCategoria));
	}
