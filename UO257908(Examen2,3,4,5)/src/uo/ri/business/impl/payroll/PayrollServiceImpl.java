...
import uo.ri.business.impl.payroll.command.FindPayrollsProductivityNull;
...
public class PayrollServiceImpl implements PayrollService {
	...
	@Override
	public List<PayrollDto> findPayrollsProductivityNull() throws BusinessException {
		return executor.execute(new FindPayrollsProductivityNull());
	}
