...
public interface MechanicCrudService {
	...
	List<MechanicDto> findMechanicsUsedRepuesto() throws BusinessException;

	List<MechanicDto> findMechanicsWithoutActiveContract(Long idCategoria) throws BusinessException;
